...
discussion: 
last_update:
  author: James Rapp, Uma Anbazhagan
  date: 2026-05-30
---
...
In SAP, a Data Product is a data set exposed for consumption outside the boundaries of the producing application via APIs and described by high quality metadata that can be accessed through the Data Product Catalog.
- It is a **business data set** and consists of one or more business object entities, related objects, analytical data, etc
...
![Data Products](drawio/sap-dp.png)
...
SAP Data Products also support customer extensions within any SAP Sources & locally defined extension fields to build Data Product Customer Extensions. This requires activation of data package directly to enable custom modeling directly.

![drawio](drawio/dp-extensibility.drawio)

![Data Products](drawio/dp-extensibility.png)
